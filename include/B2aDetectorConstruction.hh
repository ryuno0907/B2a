...
class B2aDetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  private:
    ...
    G4LogicalVolume*  fLogicCollimator;    // pointer to the logical Collimator

    G4Material*        fTargetMaterial;  // pointer to the target  material
    G4Material*        fChamberMaterial; // pointer to the chamber material
    G4Material*        fCollimatorMaterial; // pointer to the Collimator material


    G4UserLimits* fStepLimit;            // pointer to user step limits

    G4double fMagneticFieldStrength;
    G4ThreeVector fMagneticFieldDirection;
